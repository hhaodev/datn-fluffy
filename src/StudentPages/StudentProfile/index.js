                                ...
                                <div className='view__form'>
                                    ...
                                    >
                                        <div className='view__firsts'>
                                            ...
                                            >
                                                <Input placeholder='Hoang' style={{ height: "50px", width: '258px' }} className='profile__input'/>
                                            </Form.Item>
                                            ...
                                            >
                                                <Input placeholder='Tran' style={{ height: "50px", width: '278px', width: '278px' }} />
                                            </Form.Item>
                                        </div>
                                        ...
                                        <div className='view__email'>
                                            <Form.Item
                                                ...
                                                className='view__firsts1'
                                            >
                                                <Input placeholder='tranthanhhoang2802@gmail.com' style={{ height: "50px", width: '258px' }} />
                                            </Form.Item>
